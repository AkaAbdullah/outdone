    ...
    <div className='maindiv'>
        <div className='columns'>
            <div className='div-prop column is-4 '>
                <p className='font-style '>Gift with <br/>Confidence</p>
                <p className='slogan-paragraph'>Special occasions are stressful.</p>
                <p className='slogan-paragraph'>Outdone's Ai-powered gift recommender</p>
                <p className='slogan-paragraph'>gives you one less thing to worry about.</p>
